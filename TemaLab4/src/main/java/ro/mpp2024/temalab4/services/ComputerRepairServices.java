...
public class ComputerRepairServices {
    ...
    public int addComputerRepairRequest(String ownerName, String ownerAddress, String phone, String model, String date, String problem) throws ro.mpp2024.temalab4.services.ServicesException {
       try {
